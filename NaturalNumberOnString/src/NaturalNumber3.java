...
public class NaturalNumber3 extends NaturalNumberSecondary {
    ...
    /**
     * Multiplies the NaturalNumber by ten and adds the argument.
     *
     * @ensures NaturalNumber = this * 10 + k
     *
     */
    @Override
    ...
    /**
     * Divides the number by ten and return the remainder.
     *
     * @return NaturalNumber % 10
     * @ensures NaturalNumber / 10
     */
    @Override
    public final int divideBy10() {
        ...
        String r;
        if (!this.rep.isEmpty()) {
            r = this.rep.substring(this.rep.length() - 1, this.rep.length());
    ...
    /**
     * Returns if the NaturalNumber is zero.
     *
