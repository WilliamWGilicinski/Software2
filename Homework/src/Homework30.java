...
//            int pc) {
//        int nextPrim = pc + 1;
//        while (nextPrim < cp.length
//                && !isPrimitiveInstructionByteCode(cp[nextPrim])) {
//            if (cp[nextPrim] == 6) {
//                nextPrim = cp[nextPrim + 1];
//            } else {
//                if (conditionalJumpCondition(wbs, nextPrim)) {
//                    nextPrim = cp[nextPrim + 1];
//                } else {
//                    nextPrim++;
//                }
