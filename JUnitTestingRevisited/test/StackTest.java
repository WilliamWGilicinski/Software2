...
public abstract class StackTest {
    ...
    @Test
    public final void testLength8() {
        Stack<String> s = this.createFromArgsTest("a", "b", "c", "d", "e", "f",
                "g", "h");
        int lengthRef = 8;
    ...
    @Test
    public final void testPushOneWord() {
        Stack<String> s = this.createFromArgsTest("red", "orange", "yellow");
        Stack<String> sExpected = this.createFromArgsRef("white", "red",
                "orange", "yellow");
        s.push("white");
        assertEquals(sExpected, s);
    }
    ...
    @Test
    public final void testPushThreeWords() {
        Stack<String> s = this.createFromArgsTest("Red");
        Stack<String> sExpected = this.createFromArgsRef("Blue", "Cyan",
                "Turquoise", "Red");
        s.push("Turquoise");
        s.push("Cyan");
        s.push("Blue");
