...
public class JCFExplorationsTest {
    ...
    public final void testGiveRaiseOSU2() {
        ...
        components.map.Map<String, Integer> m = this.mapCreateFromArgsOSU(
                "stark", "30000", "lannister", "100000", "snow", "40000");
        components.map.Map<String, Integer> mExpected = this
                .mapCreateFromArgsOSU("lannister", "100000", "stark", "30000",
                        "snow", "40000");
        /* The Call */
        JCFExplorations.giveRaise(m, 'm', 10);
        /* Evaluation */
        assertEquals(mExpected, m);
    }
    ...
    public final void testGiveRaiseJCF2() {
        ...
        java.util.Map<String, Integer> m = this.mapCreateFromArgsJCF("stark",
                "30000", "lannister", "100000", "snow", "40000");
        java.util.Map<String, Integer> mExpected = this.mapCreateFromArgsJCF(
                "lannister", "100000", "stark", "30000", "snow", "40000");
        /* The Call */
        JCFExplorations.giveRaise(m, 'm', 10);
        /* Evaluation */
        assertEquals(mExpected, m);
    ...
    public final void testGiveRaiseOSU3() {
        ...
        components.map.Map<String, Integer> m = this.mapCreateFromArgsOSU(
                "stark", "30000", "lannister", "100000", "snow", "40000");
        components.map.Map<String, Integer> mExpected = this
                .mapCreateFromArgsOSU("lannister", "150000", "stark", "30000",
                        "snow", "40000");
        /* The Call */
        JCFExplorations.giveRaise(m, 'l', 50);
        /* Evaluation */
        assertEquals(mExpected, m);
    }
    ...
    public final void testGiveRaiseJCF3() {
        ...
        java.util.Map<String, Integer> m = this.mapCreateFromArgsJCF("stark",
                "30000", "lannister", "100000", "snow", "40000");
        java.util.Map<String, Integer> mExpected = this.mapCreateFromArgsJCF(
                "lannister", "150000", "stark", "30000", "snow", "40000");
        /* The Call */
        JCFExplorations.giveRaise(m, 'l', 50);
        /* Evaluation */
        assertEquals(mExpected, m);
    ...
    public final void testIncrementAllJCF3() {
        /* Setup */
        java.util.Set<NaturalNumber> s = this.setCreateFromArgsJCF();
        java.util.Set<NaturalNumber> sExpected = this.setCreateFromArgsJCF();
        /* The Call */
        JCFExplorations.incrementAll(s);
        /* Evaluation */
        assertEquals(sExpected, s);
    ...
    @Test
    public final void testIncrementAllJCF4() {
        /* Setup */
    ...
    public final void testIncrementAllOSU3() {
        /* Setup */
        components.set.Set<NaturalNumber> s = this.setCreateFromArgsOSU();
        components.set.Set<NaturalNumber> sExpected = this
                .setCreateFromArgsOSU();
        /* The Call */
        JCFExplorations.incrementAll(s);
        /* Evaluation */
        assertEquals("Incremented set's size: ", sExpected.size(), s.size());
    ...
    @Test
    public final void testIncrementAllOSU4() {
        /* Setup */
    ...
    @Test
    public final void testIncrementAllOSU5() {
        /* Setup */
        components.set.Set<NaturalNumber> s = this
                .setCreateFromArgsOSU("123456789123456789", "3", "31", "127");
        components.set.Set<NaturalNumber> sExpected = this
                .setCreateFromArgsOSU("123456789123456790", "4", "32", "128");
        /* The Call */
        JCFExplorations.incrementAll(s);
        /* Evaluation */
        assertEquals("Incremented set's size: ", sExpected.size(), s.size());
    ...
    @Test
    public final void testIncrementAllJCF5() {
        /* Setup */
        java.util.Set<NaturalNumber> s = this
                .setCreateFromArgsJCF("123456789123456789", "2", "3", "4");
        java.util.Set<NaturalNumber> sExpected = this
                .setCreateFromArgsJCF("123456789123456790", "3", "4", "5");
        /* The Call */
        JCFExplorations.incrementAll(s);
        /* Evaluation */
        assertEquals("Incremented set's size: ", sExpected.size(), s.size());
