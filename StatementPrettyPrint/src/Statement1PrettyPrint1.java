    ...
    public void prettyPrint(SimpleWriter out, int offset) {
        ...
        switch (this.kind()) {
            ...
            case IF: {
                ...
                body.prettyPrint(out, offset + ind);
                printSpaces(out, offset);
                out.println("END IF");
                this.assembleIf(cond, body);
            ...
            case IF_ELSE: {
                ...
                printSpaces(out, offset);
                out.println("IF " + toStringCondition(cond) + " THEN");
                s1.prettyPrint(out, offset + ind);
                printSpaces(out, offset);
                out.println("ELSE");
                s2.prettyPrint(out, offset + ind);
                printSpaces(out, offset);
                out.println("END IF");

                this.assembleIfElse(cond, s1, s2);
