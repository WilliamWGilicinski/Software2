...
public final class SequenceSmoothTest {
    ...
    @Test
    public void test5() {
        Sequence<Integer> seq1 = this.createFromArgs(1, 3, 5, 7, 9, 11);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(1, 3, 5, 7, 9, 11);
        Sequence<Integer> seq2 = this.createFromArgs(1, 2, 3, 2, 4, 5, 634, 3);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(2, 4, 6, 8, 10);
    ...
    public void test7() {
        ...
        Sequence<Integer> seq2 = this.createFromArgs(45);
    ...
    @Test
    public void test11() {
        Sequence<Integer> seq1 = this.createFromArgs(-8, 3);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-8, 3);
